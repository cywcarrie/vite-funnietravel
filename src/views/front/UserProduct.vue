      ...
      <div class="row d-flex justify-content-center mb-5 mt-4 mt-md-0">
        ...
        <div class="row d-flex justify-content-center py-5 mt-2 rounded-2">
          ...
          <div class="col-lg-6 mt-4 mt-lg-0">
            ...
            <div class="mt-3">
              <p class="mb-2">1. 訂單成立後，若欲辦理更改或是取消行程，請務必先洽詢專員。</p>
              <p class="mb-2">
                2. 訂單成立後，若更改行程或取消行程，本公司將另行收取相應之手續費。
              </p>
              <p class="mb-2">
                3. 訂單成立後，更改或取消行程須依各航空公司之相關規定辦理，並收取其所定之相關費用。
              </p>
              <p class="mb-2">
                4.
                訂單成立後，更改或取消行程涉及之飯店相關異動手續費或罰金，依各飯店實際回覆之金額為準。
              </p>
              <p class="mb-2">
                5.
                若於出發當日取消行程、未事先通知而未參加，或因個人因素遭拒絕入境者，將無法申請退費。
              </p>
              <p>
                6.
                若遇不可抗力因素(例如天候異常等)導致行程被迫更改或取消，公司將不另行收取任何手續費。
              </p>
            </div>
          </div>
        </div>
